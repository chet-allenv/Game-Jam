...
draw_text(room_width / 2, room_height * 0.1, "What would you choose...?")	// "Pick a card"
...
for (var i = 0; i < 4; i++) {
	...
	var _text = types[1, i]
	draw_text(room_width * 0.8 + (string_width(_text) / 2), room_height * 0.03 + (_space * 0.2 * i), _text)
}
